...
/***/ "./node_modules/remarkable/dist/esm/index.js":
/*!***************************************************!*\
  !*** ./node_modules/remarkable/dist/esm/index.js ***!
  \***************************************************/
...
/* harmony import */ var remarkable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! remarkable */ "./node_modules/remarkable/dist/esm/index.js");
/* harmony import */ var components_textarea__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! components/textarea */ "./src/components/textarea.coffee");
var Article;
...
/* harmony default export */ __webpack_exports__["default"] = (Article = class Article {
  constructor() {
    ...
    this.value = mithril_stream__WEBPACK_IMPORTED_MODULE_1___default()('This is the default editor\nWe have lots going on here.');
  ...
  header() {
    ...
    }, mithril__WEBPACK_IMPORTED_MODULE_0__["trust"]('Untitled Document!!!'))), mithril__WEBPACK_IMPORTED_MODULE_0__('section.sub', mithril__WEBPACK_IMPORTED_MODULE_0__('.editor', 'Editor'), mithril__WEBPACK_IMPORTED_MODULE_0__('.preview', 'Preview'), mithril__WEBPACK_IMPORTED_MODULE_0__('em')));
  }

  panes() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('.panes', mithril__WEBPACK_IMPORTED_MODULE_0__(components_textarea__WEBPACK_IMPORTED_MODULE_3__["default"], {
      value: this.value
    }), mithril__WEBPACK_IMPORTED_MODULE_0__('.pane.preview.markdown', mithril__WEBPACK_IMPORTED_MODULE_0__["trust"](this.md.render(this.value()))), mithril__WEBPACK_IMPORTED_MODULE_0__('em'));
  }

  view() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('article', [this.header(), this.panes()]);
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Sidebar = class Sidebar {
  view() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('nav', mithril__WEBPACK_IMPORTED_MODULE_0__('a', {
      href: '#'
    }, 'All Notes'));
  }
...
/* harmony import */ var mithril_stream__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! mithril/stream */ "./node_modules/mithril/stream.js");
/* harmony import */ var mithril_stream__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(mithril_stream__WEBPACK_IMPORTED_MODULE_1__);
var HotkeyHeading, HotkeyWrap, Textarea, find_line;
...
find_line = function(lines, value) {
...
// - no selection
HotkeyWrap = class HotkeyWrap {
  static insert(value, start_at, end_at, str_start, str_end) {
    var data, end_char, end_index, end_sub_0, end_sub_1, lines, new_end_at, new_start_at, start_char, start_index, start_sub_0, start_sub_1;
    lines = value.split("\n");
    [start_index, start_char] = find_line(lines, start_at);
    [end_index, end_char] = find_line(lines, end_at);
    start_sub_0 = lines[start_index].substring(0, start_at - start_char);
    start_sub_1 = lines[start_index].substring(start_at, lines[start_index].length);
    start_sub_0 += str_start;
    lines[start_index] = [start_sub_0, start_sub_1].join('');
    if (start_index === end_index) {
      // since they are on the same line, need to bump up the end_at
      end_at += str_start.length;
    }
    end_sub_0 = lines[end_index].substring(0, end_at - end_char);
    end_sub_1 = lines[end_index].substring(end_at, lines[end_index].length);
    end_sub_0 += str_end;
...
HotkeyHeading = class HotkeyHeading {
...
/* harmony default export */ __webpack_exports__["default"] = (Textarea = class Textarea {
  constructor() {
    ...
    this.meta = mithril_stream__WEBPACK_IMPORTED_MODULE_1___default()(false);
    this.shift = mithril_stream__WEBPACK_IMPORTED_MODULE_1___default()(false);
    this.selectionStart = mithril_stream__WEBPACK_IMPORTED_MODULE_1___default()(false);
    this.selectionEnd = mithril_stream__WEBPACK_IMPORTED_MODULE_1___default()(false);
  }
  ...
  onupdate(vnode) {
    if (this.selectionStart() !== false) {
      vnode.dom.selectionStart = this.selectionStart();
      this.selectionStart(false);
    }
    if (this.selectionEnd() !== false) {
      vnode.dom.selectionEnd = this.selectionEnd();
      return this.selectionEnd(false);
    }
  }
      ...
      onkeydown: (e) => {
        ...
        if (this.meta()) {
          ...
          if (['1', '2', '3', '4', '5'].indexOf(e.key) !== -1) {
            data = HotkeyHeading.insert(this.value(), parseInt(e.key), start_at);
            this.value(data.value);
            this.selectionStart(data.selectionStart);
            return this.selectionEnd(data.selectionEnd);
          } else if (e.key === 'b') {
            data = HotkeyWrap.insert(this.value(), start_at, end_at, '**', '**');
            this.value(data.value);
            this.selectionStart(data.selectionStart);
            return this.selectionEnd(data.selectionEnd);
          } else if (e.key === 'f') {
            data = HotkeyWrap.insert(this.value(), start_at, end_at, "<strong class='r'>", "</strong>");
            this.value(data.value);
            this.selectionStart(data.selectionStart);
            return this.selectionEnd(data.selectionEnd);
          } else if (e.key === 'd') {
            data = HotkeyWrap.insert(this.value(), start_at, end_at, "<strong class='h'>", "</strong>");
            this.value(data.value);
            this.selectionStart(data.selectionStart);
            return this.selectionEnd(data.selectionEnd);
          }
  ...
  view() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('textarea.pane.editor', this.attrs());
  }
...
/* harmony default export */ __webpack_exports__["default"] = (ArticleView = class ArticleView {
  view() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('main', [mithril__WEBPACK_IMPORTED_MODULE_0__(components_sidebar__WEBPACK_IMPORTED_MODULE_1__["default"]), mithril__WEBPACK_IMPORTED_MODULE_0__(components_article__WEBPACK_IMPORTED_MODULE_2__["default"])]);
  }
