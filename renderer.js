...
/***/ "./node_modules/canvas-to-image/js/canvas-to-image.min.js":
/*!****************************************************************!*\
  !*** ./node_modules/canvas-to-image/js/canvas-to-image.min.js ***!
  \****************************************************************/
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var canvasToImage=canvasToImage||function(p){"use strict";if("undefined"==typeof navigator||!/MSIE [1-9]\./.test(navigator.userAgent)){var e,g,m,v,w,y,h,S,t,r=r||(e=p.document,g=e.createElementNS("http://www.w3.org/1999/xhtml","a"),m="download"in g,v=/Version\/[\d\.]+.*Safari/.test(navigator.userAgent),w=p.webkitRequestFileSystem,y=p.requestFileSystem||w||p.mozRequestFileSystem,h="application/octet-stream",S=0,t=a.prototype,"undefined"!=typeof navigator&&navigator.msSaveOrOpenBlob?function(e,t,n){return n||(e=E(e)),navigator.msSaveOrOpenBlob(e,t||"download")}:(t.abort=function(){this.readyState=this.DONE,O(this,"abort")},t.readyState=t.INIT=0,t.WRITING=1,t.DONE=2,t.error=t.onwritestart=t.onprogress=t.onwrite=t.onabort=t.onerror=t.onwriteend=null,function(e,t,n){return new a(e,t,n)})),i=function(e,t,n){t=t||"",n=n||512;for(var a=atob(e),o=[],r=0;r<a.length;r+=n){for(var i=a.slice(r,r+n),c=new Array(i.length),u=0;u<i.length;u++)c[u]=i.charCodeAt(u);var f=new Uint8Array(c);o.push(f)}return new Blob(o,{type:t})};return function(e,t,n){var a;"object"==typeof t?(name=t.name||"image",n=t.type||"png",a=t.quality||1):(name=t||"image",n=n||"png");var o=document.getElementById(e);switch(n=n.toLowerCase()){case"jpg":!function(e,t,n){t+=".jpg";var a=e.toDataURL("image/jpeg",n);a=a.replace(/^data:image\/jpeg;base64,/,"");var o=i(a,"image/jpeg");r(o,t)}(o,name,a);break;default:!function(e,t,n){t+=".png";var a=e.toDataURL("image/png",n);a=a.replace(/^data:image\/png;base64,/,"");var o=i(a,"image/png");r(o,t)}(o,name,a)}}}function b(){return p.URL||p.webkitURL||p}function c(e){(p.setImmediate||p.setTimeout)(function(){throw e},0)}function R(e){setTimeout(function(){"string"==typeof e?b().revokeObjectURL(e):e.remove()},4e4)}function O(e,t,n){for(var a=(t=[].concat(t)).length;a--;){var o=e["on"+t[a]];if("function"==typeof o)try{o.call(e,n||e)}catch(e){c(e)}}}function E(e){return/^\s*(?:text\/\S*|application\/xml|\S*\/\S*\+xml)\s*;.*charset\s*=\s*utf-8/i.test(e.type)?new Blob(["ï»¿",e],{type:e.type}):e}function a(a,n,e){function o(){O(f,"writestart progress write writeend".split(" "))}function r(){if(u&&v&&"undefined"!=typeof FileReader){var t=new FileReader;return t.onloadend=function(){var e=t.result;u.location.href="data:attachment/file"+e.slice(e.search(/[,;]/)),f.readyState=f.DONE,o()},t.readAsDataURL(a),void(f.readyState=f.INIT)}!s&&c||(c=b().createObjectURL(a)),u?u.location.href=c:void 0===p.open(c,"_blank")&&v&&(p.location.href=c),f.readyState=f.DONE,o(),R(c)}function i(e){return function(){if(f.readyState!==f.DONE)return e.apply(this,arguments)}}e||(a=E(a));var c,u,t,f=this,d=a.type,s=!1,l={create:!0,exclusive:!1};if(f.readyState=f.INIT,n=n||"download",m)return c=b().createObjectURL(a),void setTimeout(function(){var e,t;g.href=c,g.download=n,e=g,t=new MouseEvent("click"),e.dispatchEvent(t),o(),R(c),f.readyState=f.DONE});p.chrome&&d&&d!==h&&(t=a.slice||a.webkitSlice,a=t.call(a,0,a.size,h),s=!0),w&&"download"!==n&&(n+=".download"),d!==h&&!w||(u=p),y?(S+=a.size,y(p.TEMPORARY,S,i(function(e){e.root.getDirectory("saved",l,i(function(e){function t(){e.getFile(n,l,i(function(n){n.createWriter(i(function(t){t.onwriteend=function(e){u.location.href=n.toURL(),f.readyState=f.DONE,O(f,"writeend",e),R(n)},t.onerror=function(){var e=t.error;e.code!==e.ABORT_ERR&&r()},"writestart progress write abort".split(" ").forEach(function(e){t["on"+e]=f["on"+e]}),t.write(a),f.abort=function(){t.abort(),f.readyState=f.DONE},f.readyState=f.WRITING}),r)}),r)}e.getFile(n,{create:!1},i(function(e){e.remove(),t()}),i(function(e){e.code===e.NOT_FOUND_ERR?t():r()}))}),r)}),r)):r()}}("undefined"!=typeof self&&self||"undefined"!=typeof window&&window||this.content); true&&module.exports?module.exports=canvasToImage: true&&null!==__webpack_require__(/*! !webpack amd define */ "./node_modules/webpack/buildin/amd-define.js")&&null!==__webpack_require__(/*! !webpack amd options */ "./node_modules/webpack/buildin/amd-options.js")&&!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){return canvasToImage}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
...
/* harmony default export */ __webpack_exports__["default"] = (Article = class Article {
  ...
  image_resize() {
    ...
    return electron__WEBPACK_IMPORTED_MODULE_9__["ipcRenderer"].send('sharp-resize', {
  ...
  image_border() {
    ...
    return fs__WEBPACK_IMPORTED_MODULE_8___default.a.writeFile(path, el.toDataURL().replace(/^data:image\/png;base64,/, ""), 'base64', function(err) {
      console.log(err);
      return electron__WEBPACK_IMPORTED_MODULE_9__["ipcRenderer"].send('sharp-border', {
        overlay: path,
        source: asset.path
      });
    });
  ...
  image_paint() {
    var asset;
    asset = common_data__WEBPACK_IMPORTED_MODULE_4__["default"].get_asset();
    return electron__WEBPACK_IMPORTED_MODULE_9__["ipcRenderer"].send('drawing-window', asset);
  }
...
/* harmony import */ var canvas_to_image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! canvas-to-image */ "./node_modules/canvas-to-image/js/canvas-to-image.min.js");
/* harmony import */ var canvas_to_image__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(canvas_to_image__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony default export */ __webpack_exports__["default"] = (Sidebar = class Sidebar {
  ...
  reveal() {
    return electron__WEBPACK_IMPORTED_MODULE_4__["ipcRenderer"].send('assets-reveal', {
      path: `${common_data__WEBPACK_IMPORTED_MODULE_2__["default"].home()}/${common_data__WEBPACK_IMPORTED_MODULE_2__["default"].active_file()}/assets/`
    });
  }
  ...
  reindex() {
    electron__WEBPACK_IMPORTED_MODULE_4__["ipcRenderer"].send('request-markdown-files');
    if (common_data__WEBPACK_IMPORTED_MODULE_2__["default"].active_file()) {
      return electron__WEBPACK_IMPORTED_MODULE_4__["ipcRenderer"].send('request-assets', {
        project: common_data__WEBPACK_IMPORTED_MODULE_2__["default"].active_file()
      });
    }
  ...
  new_project() {
    return electron__WEBPACK_IMPORTED_MODULE_4__["ipcRenderer"].send('prompt-new');
  }
  ...
  view() {
    var file;
    return [
      mithril__WEBPACK_IMPORTED_MODULE_0__('.nav_heading',
      mithril__WEBPACK_IMPORTED_MODULE_0__('.btn.refresh',
      {
        onclick: this.reindex
      },
      mithril__WEBPACK_IMPORTED_MODULE_0__('span.fas.fa-sync')),
      mithril__WEBPACK_IMPORTED_MODULE_0__('.btn.new',
      {
        onclick: this.new_project
      },
      mithril__WEBPACK_IMPORTED_MODULE_0__('span.fas.fa-plus')),
      mithril__WEBPACK_IMPORTED_MODULE_0__('em')),
      mithril__WEBPACK_IMPORTED_MODULE_0__('nav',
      mithril__WEBPACK_IMPORTED_MODULE_0__('.title',
...
/* harmony import */ var common_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! common/data */ "./src/common/data.coffee");
/* harmony import */ var common_save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! common/save */ "./src/common/save.coffee");
/* harmony import */ var lib_text_insert__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lib/text_insert */ "./src/lib/text_insert.coffee");
    ...
    return attrs = {
      ondrop: (ev) => {
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          date = new Date().getTime();
          epoch = Math.round(date / 1000);
          ext = path__WEBPACK_IMPORTED_MODULE_8___default.a.extname(file.path);
          basename = path__WEBPACK_IMPORTED_MODULE_8___default.a.basename(file.path);
          ...
          // save modified
          fs__WEBPACK_IMPORTED_MODULE_7___default.a.copyFile(file.path, modified_asset_path, (err) => {
            if (err) {
              console.log('copyFile', err);
            }
            lib_text_insert__WEBPACK_IMPORTED_MODULE_5__["default"].at(`\n![](${modified_asset_path})`);
            return mithril__WEBPACK_IMPORTED_MODULE_0__["redraw"](true);
          });
          //save orginal
          fs__WEBPACK_IMPORTED_MODULE_7___default.a.copyFile(file.path, original_asset_path, (err) => {
            if (err) {
              return console.log('copyFile', err);
            }
          });
          common_data__WEBPACK_IMPORTED_MODULE_3__["default"].keep_selection();
          results.push(electron__WEBPACK_IMPORTED_MODULE_6__["ipcRenderer"].send('request-assets', {
            project: common_data__WEBPACK_IMPORTED_MODULE_3__["default"].active_file()
          }));
        }
        return results;
      ...
      onkeydown: (e) => {
        ...
        if (common_data__WEBPACK_IMPORTED_MODULE_3__["default"].meta()) {
          ...
          if (['1', '2', '3', '4', '5'].indexOf(e.key) !== -1) {
            ...
            return common_save__WEBPACK_IMPORTED_MODULE_4__["default"].save();
          } else if (e.key === 'b') {
            ...
            return electron__WEBPACK_IMPORTED_MODULE_6__["ipcRenderer"].send('toggle-fullscreen');
