...
/* harmony import */ var components_preview__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! components/preview */ "./src/components/preview.coffee");
/* harmony import */ var common_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! common/data */ "./src/common/data.coffee");
/* harmony import */ var common_save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! common/save */ "./src/common/save.coffee");
/* harmony import */ var lib_hotkey_heading__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lib/hotkey_heading */ "./src/lib/hotkey_heading.coffee");
/* harmony import */ var lib_hotkey_wrap__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lib/hotkey_wrap */ "./src/lib/hotkey_wrap.coffee");
var Article;
...
/* harmony default export */ __webpack_exports__["default"] = (Article = class Article {
  ...
  bold() {
    ...
    data = lib_hotkey_wrap__WEBPACK_IMPORTED_MODULE_6__["default"].insert(common_data__WEBPACK_IMPORTED_MODULE_3__["default"].document(), start_at, end_at, "**", "**");
  ...
  red() {
    ...
    start_at = target.selectionStart;
    end_at = target.selectionEnd;
    data = lib_hotkey_wrap__WEBPACK_IMPORTED_MODULE_6__["default"].insert(common_data__WEBPACK_IMPORTED_MODULE_3__["default"].document(), start_at, end_at, "<strong class='r'>", "</strong>");
    common_data__WEBPACK_IMPORTED_MODULE_3__["default"].document(data.value);
    common_data__WEBPACK_IMPORTED_MODULE_3__["default"].selectionStart(data.selectionStart);
    return common_data__WEBPACK_IMPORTED_MODULE_3__["default"].selectionEnd(data.selectionEnd);
  }
  ...
  highlight() {
    ...
    start_at = target.selectionStart;
    end_at = target.selectionEnd;
    data = lib_hotkey_wrap__WEBPACK_IMPORTED_MODULE_6__["default"].insert(common_data__WEBPACK_IMPORTED_MODULE_3__["default"].document(), start_at, end_at, "<strong class='h'>", "</strong>");
    common_data__WEBPACK_IMPORTED_MODULE_3__["default"].document(data.value);
    common_data__WEBPACK_IMPORTED_MODULE_3__["default"].selectionStart(data.selectionStart);
    return common_data__WEBPACK_IMPORTED_MODULE_3__["default"].selectionEnd(data.selectionEnd);
  }
  ...
  header() {
    ...
    }, mithril__WEBPACK_IMPORTED_MODULE_0__["trust"](common_data__WEBPACK_IMPORTED_MODULE_3__["default"].active_file()))), mithril__WEBPACK_IMPORTED_MODULE_0__('section.sub', mithril__WEBPACK_IMPORTED_MODULE_0__('.editor', mithril__WEBPACK_IMPORTED_MODULE_0__('span.lbl', 'Editor'), mithril__WEBPACK_IMPORTED_MODULE_0__('span.btn.save', {
      onclick: this.save
    ...
    }, mithril__WEBPACK_IMPORTED_MODULE_0__('span', 'highlight')), mithril__WEBPACK_IMPORTED_MODULE_0__('em')), mithril__WEBPACK_IMPORTED_MODULE_0__('.preview', mithril__WEBPACK_IMPORTED_MODULE_0__('span.lbl', 'Preview'), mithril__WEBPACK_IMPORTED_MODULE_0__('span.btn.crop', {
      onclick: this.image_crop
    }, mithril__WEBPACK_IMPORTED_MODULE_0__('span.fas.fa-crop-alt')), mithril__WEBPACK_IMPORTED_MODULE_0__('span.btn.crop', {
      onclick: this.image_resize
    }, mithril__WEBPACK_IMPORTED_MODULE_0__('span.fas.fa-compress')), mithril__WEBPACK_IMPORTED_MODULE_0__('span.btn.border', {
      onclick: this.image_border
    }, mithril__WEBPACK_IMPORTED_MODULE_0__('span.fas.fa-border-style'))), mithril__WEBPACK_IMPORTED_MODULE_0__('em')));
  }

  panes() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('.panes', mithril__WEBPACK_IMPORTED_MODULE_0__(components_textarea__WEBPACK_IMPORTED_MODULE_1__["default"]), mithril__WEBPACK_IMPORTED_MODULE_0__(components_preview__WEBPACK_IMPORTED_MODULE_2__["default"]), mithril__WEBPACK_IMPORTED_MODULE_0__('em'));
  }
  ...
  attrs() {
    ...
    return attrs = {
      ...
      onclick: (e) => {
        ...
        return common_data__WEBPACK_IMPORTED_MODULE_3__["default"]._selectionEnd(e.target.selectionEnd || 0);
      },
      onkeydown: (e) => {
...
/* harmony default export */ __webpack_exports__["default"] = (ArticleView = class ArticleView {
  view() {
    return mithril__WEBPACK_IMPORTED_MODULE_0__('main', mithril__WEBPACK_IMPORTED_MODULE_0__(components_sidebar__WEBPACK_IMPORTED_MODULE_1__["default"]), common_data__WEBPACK_IMPORTED_MODULE_4__["default"].active_file() ? [mithril__WEBPACK_IMPORTED_MODULE_0__(components_article__WEBPACK_IMPORTED_MODULE_2__["default"]), mithril__WEBPACK_IMPORTED_MODULE_0__(components_infobar__WEBPACK_IMPORTED_MODULE_3__["default"])] : void 0);
  }
